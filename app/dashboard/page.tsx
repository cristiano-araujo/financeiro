...
const DATA = [
  { name: "Seg", agendamentos: 40 },
  { name: "Ter", agendamentos: 65 },
  { name: "Qua", agendamentos: 45 },
  { name: "Qui", agendamentos: 90 },
  { name: "Sex", agendamentos: 75 },
  { name: "Sáb", agendamentos: 110 },
  { name: "Dom", agendamentos: 95 },
]
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-1000">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-7">
        <Card className="col-span-4 shadow-2xl border-primary/10 overflow-hidden bg-card/40 backdrop-blur-md">
              ...
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={DATA}>
                  ...
                  <XAxis 
                    ...
                    axisLine={false} 
                    tickLine={false} 
                    tick={{ fontSize: 10, fill: "currentColor", opacity: 0.4, fontWeight: 900 }}
                    dy={15}
                  />
                  <YAxis 
                    axisLine={false} 
