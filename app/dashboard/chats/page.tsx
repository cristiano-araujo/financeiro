              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="flex items-center gap-2">
                    <CardTitle className="text-lg font-black tracking-tight">{activeChat.client}</CardTitle>
          ...
          <CardContent className="flex-1 p-8 space-y-8 overflow-y-auto z-10 scrollbar-thin scrollbar-thumb-primary/10">
            <div className="flex flex-col items-center mb-4">
              <Badge variant="outline" className="text-[10px] font-bold uppercase tracking-widest px-4 py-1 bg-muted/30">
                Hoje, {activeChat.lastUpdate}
              </Badge>
            </div>

            {/* Mensagem do Cliente */}
            <div className="flex flex-col items-start gap-2 max-w-[85%] animate-in slide-in-from-left-4 duration-500">
              ...
              <span className="text-[10px] text-muted-foreground font-black uppercase tracking-widest ml-2">Cliente • 10:02</span>
            </div>

            {/* Mensagem da IA */}
            <div className="flex flex-col items-end gap-2 max-w-[85%] ml-auto animate-in slide-in-from-right-4 duration-500">
              <div className="bg-primary text-primary-foreground p-4 rounded-3xl rounded-tr-none text-sm shadow-xl border border-primary/20 leading-relaxed relative overflow-hidden">
                ...
                Olá {activeChat.client.split(' ')[0]}! Tudo bem? Deixe-me verificar aqui na agenda... 
                <br /><br />
              ...
              <span className="text-[10px] text-primary font-black uppercase tracking-widest flex items-center gap-1.5 mr-2">
                <Bot className="h-3.5 w-3.5" /> IA Beatriz • 10:02
              </span>
            </div>

            {/* Mensagem do Cliente */}
            <div className="flex flex-col items-start gap-2 max-w-[85%] animate-in slide-in-from-left-4 duration-500 delay-200">
              <div className="bg-muted/80 backdrop-blur-sm p-4 rounded-3xl rounded-tl-none text-sm shadow-sm border border-muted-foreground/10 leading-relaxed">
                O das 10h não dá? Vi no site que tinha.
              </div>
              <span className="text-[10px] text-muted-foreground font-black uppercase tracking-widest ml-2">Cliente • 10:03</span>
            </div>

            {/* Mensagem da IA */}
            <div className="flex flex-col items-end gap-2 max-w-[85%] ml-auto animate-in slide-in-from-right-4 duration-500 delay-300">
              <div className="bg-primary text-primary-foreground p-4 rounded-3xl rounded-tr-none text-sm shadow-xl border border-primary/20 leading-relaxed relative overflow-hidden">
                Ah, peço desculpas! Você tem razão, acabei de reconfirmar aqui e o horário das **10:00** ainda está vago. 
                <br /><br />
                Deseja que eu reserve esse horário para você agora mesmo?
              </div>
              <span className="text-[10px] text-primary font-black uppercase tracking-widest flex items-center gap-1.5 mr-2">
                <Bot className="h-3.5 w-3.5" /> IA Beatriz • 10:03
              </span>
            </div>
